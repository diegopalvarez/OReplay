...
enum class StageType(val id: String) {
    CLASSIC("29d5050b-4769-4be5-ace4-7e5973f68e3c"),
    MASS_START("ce5e95ea-9f2b-4a98-86e1-2b43651adfee"),
    CHASE_START("080f7e57-9525-4b9a-95ee-b2113f411afd"),
    OVERALL("3d4cf037-64d6-442c-969d-35452048daf9"),
    RELAY("9a918410-6dda-4c58-bec9-23839b336e59"),
    SCORE("2b5de3d0-9bc9-435a-8bd9-2d4060b86e45"),
    RAID("a30b2db1-5649-491a-b5a8-ca53e4e58461"),
    TRAIL("a30b2db1-5649-491a-b5a8-ca53e4e58461"),
